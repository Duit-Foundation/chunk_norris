  ...
  group('ChunkField utils tests', () {
    ...
    group('list', () {
      test('should create ChunkField for list', () {
        final field =
            ChunkField.list<String>('test-id', (item) => item.toString());
      ...
      test('should apply item deserializer to each element', () {
        final field = ChunkField.list<int>(
            'test-id', (item) => int.parse(item.toString()));
    ...
    group('object', () {
      test('should create ChunkField for object', () {
        final field = ChunkField.object<Map<String, String>>('test-id',
      ...
      test('should handle custom object deserialization', () {
        final field = ChunkField.object<Person>('test-id',
